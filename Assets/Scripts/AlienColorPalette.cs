...
public class AlienColorPalette : Singleton<AlienColorPalette>
{
    ...
    private readonly string[] hexColors =
    {
        ...
        "#1F1F1F", "#323232", "#4B4B4B", "#656565", "#8C8C8C", "#B3B3B3",
        "#39354A", "#4C4664", "#625C7A", "#7A7592", "#978FAF", "#B4ABC7",
        ...
        "#50614A", "#5E7058", "#6E8268", "#0E140F", "#132117", "#1A2B1F",
        "#729C6B", "#8BBF7D", "#ADCFA1", "#5B3A2B", "#704A3A", "#CCCCCC",
        "#E0E0E0", "#F4F4F4", "#262336", "#2B283D", "#4C7E89", "#6A9AA3"
    };
