...
public class GameManager : MonoBehaviour
{
    ...
    public Vector3 shipPosition;   // posi��o do Ship no mapa
    ...
    {
        Debug.Log($"[GM] Sair do planeta {CurrentPlanetIndex} � marcar conclu�do");
    ...
    public bool IsAnyPlanetReachable(Vector3 shipPos,
                                 ...
                                 float maxFuel)           // dep�sito cheio em unidades
    {
        ...
        return false;                  // nenhum planeta � alcan��vel
    }
